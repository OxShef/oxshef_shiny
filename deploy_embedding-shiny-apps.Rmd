...
Note that these "Shiny RMarkdown documents" can be deployed to shinyapps.io or Shiny Server almost identically to how regular Shiny apps can be deployed. Further documentation on [inline Shiny apps is available here](http://rmarkdown.rstudio.com/authoring_embedded_shiny.html).s